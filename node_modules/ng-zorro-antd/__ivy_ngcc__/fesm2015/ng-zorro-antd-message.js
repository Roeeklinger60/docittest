...
function NzMessageContainerComponent_nz_message_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const message_r7880 = ctx.$implicit;
    const i_r7881 = ctx.index;
    ɵngcc0.ɵɵproperty("nzMessage", message_r7880)("nzIndex", i_r7881);
} }
...
function NzMessageComponent_ng_container_9_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r7887 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("innerHTML", ctx_r7887.nzMessage.content, ɵngcc0.ɵɵsanitizeHtml);
} }
let globalCounter = 0;
/**
